...
def get_ds(config):
    # Separate Training and Validation splits as provided by dataset
    ...
    # Build tokenizers
    tokenizer_src = get_or_build_tokenizer(config, train_ds, config['lang_src'])
    tokenizer_tgt = get_or_build_tokenizer(config, train_ds, config['lang_tgt'])
